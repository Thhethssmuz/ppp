...
% ------------------------------ L A N G U A G E ------------------------------
  ...
  \AtBeginDocument{
    ...
    $if(i-will-ignore-this-for-now)$
    % Norwegian, does not at all have sensible defaults!
    \defcopappendixname{norsk}{\abstractname}{Abstrakt}
    \defcopappendixname{norsk}{\appendixname}{Vedlegg}
    \defcopappendixname{norsk}{\appendixpagename}{Vedlegg}
    \defcopappendixname{norsk}{\appendixtocname}{Vedlegg}
    \defcopappendixname{norsk}{\bibname}{Bibliografi}
    \defcopappendixname{norsk}{\chaptername}{Kapittel}
    \defcopappendixname{norsk}{\contentsname}{Innhold}
    \defcopappendixname{norsk}{\figurename}{Figur}
    \defcopappendixname{norsk}{\listfigurename}{Figurer}
    \defcopappendixname{norsk}{\listtablename}{Tabeller}
    \defcopappendixname{norsk}{\notesname}{Noter}
    \defcopappendixname{norsk}{\pagename}{Side}
    \defcopappendixname{norsk}{\refname}{Referanser}
    \defcopappendixname{norsk}{\tablename}{Tabell}

    % This is also Norwegian, in case you wandered...
    \defcopappendixname{nynorsk}{\abstractname}{Abstrakt}
    \defcopappendixname{nynorsk}{\appendixname}{Vedlegg}
    \defcopappendixname{nynorsk}{\appendixpagename}{Vedlegg}
    \defcopappendixname{nynorsk}{\appendixtocname}{Vedlegg}
    \defcopappendixname{nynorsk}{\bibname}{Bibliografi}
    \defcopappendixname{nynorsk}{\chaptername}{Kapittel}
    \defcopappendixname{nynorsk}{\contentsname}{Innhold}
    \defcopappendixname{nynorsk}{\figurename}{Figur}
    \defcopappendixname{nynorsk}{\listfigurename}{Figurar}
    \defcopappendixname{nynorsk}{\listtablename}{Tabellar}
    \defcopappendixname{nynorsk}{\notesname}{Notar}
    \defcopappendixname{nynorsk}{\pagename}{Side}
    \defcopappendixname{nynorsk}{\refname}{Referansar}
    \defcopappendixname{nynorsk}{\tablename}{Tabell}
    $endif$
...
% ------------------------------ A B S T R A C T ------------------------------
  ...
  \renewcommand\abstract[1]{
    ...
    \begin{savedabstract}
      ...
      $if(keywords)$
        \itshape{Keywords:} $for(keywords)$$keywords$$sep$, $endfor$
      $endif$
    \end{savedabstract}
  }
