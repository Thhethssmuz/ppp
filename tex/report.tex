% ------------------------ D O C U M E N T   C L A S S ------------------------
  ...
  \KOMAoptions{
    ...
    BCOR=$if(page-bcor)$$page-bcor$$else$2.5cm$endif$,
...
% ----------------------------- F O N T  S P E C ------------------------------
  ...
  % recalculate page-div after fonts are set
...
% ----------- T I T L E   P A G E   A N D   P D F   M E T A D A T A -----------
  ...
  \newcommand\ppptitle{
    \KOMAoptions{titlepage=firstiscover}% titlepage=true}
