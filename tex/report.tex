...
% ---------------- T A B L E   O F   C O N T E N T   E T C . . ----------------
  ...
  $if(article)$
    ...
    \renewcommand*\tableofcontents{%
      \pdfbookmark[$rootlevel$]{\contentsname}{\contentsname}%
      \toc@heading%
      \@starttoc{toc}%
    }
    ...
    \renewcommand*\listoffigures{%
      \pdfbookmark[$rootlevel$]{\listfigurename}{\listfigurename}%
      \lof@heading%
      \@starttoc{lof}%
    }
    ...
    \renewcommand*\listoftables{%
      \pdfbookmark[$rootlevel$]{\listtablename}{\listtablename}%
      \lot@heading%
      \@starttoc{lot}%
    }
    \makeatother
  ...
  \newcommand\toc{
    \resetsecnumdepth
    \bookmarksetupnext{level=$rootlevel$}
