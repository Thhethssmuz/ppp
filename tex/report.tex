...
% ------------------------------ L A N G U A G E ------------------------------
  ...
  \AtBeginDocument{
    ...
    \defcaptionname{english,brittesh,american}{\appendixpagename}{Appendices}
    ...
    \defcaptionname{english,british,american}{\listexamplename}{List of Programs}
    \defcaptionname{norsk,nynorsk}{\listprogramename}{Program}
    \defcaptionname{norsk}{\notesname}{Noter}
    \defcaptionname{nynorsk}{\notesname}{Notar}
    \defcaptionname{english,british,american,norks,nynorsk}{\programname}{Program}
  }
...
% -------------------------------- B L O C K S --------------------------------
  ...
  \newfloat{program}{tbh}{prog}[$if(report)$chapter$else$section$endif$]
  \floatname{program}{\programname}
  \DeclareCaptionSubType{program}
  \captionsetup[subprogram]{margin=0.5em}

  \newfloat{example}{tbh}{ex}[$if(report)$chapter$else$section$endif$]
  \floatname{example}{\examplename}
  \DeclareCaptionSubType{example}
  \captionsetup[subexample]{margin=0.5em}
