...
% ---------------------------------- M I S C ----------------------------------
  ...
  % set style of description lists
...
% --------------------------------- L I N K S ---------------------------------
  ...
  \hypersetup{
    bookmarks=true,
    bookmarksdepth=$if(bmkdepth)$$bmkdepth$$else$3$endif$,
    bookmarksopen=true,
...
% ---------------- T A B L E   O F   C O N T E N T   E T C . . ----------------
  ...
  \newcommand\ppptableofcontents[1][1]{
    $if(article)$$else$
    \end{pppmulticol}
    \ifthenelse{\equal{#1}{1}}{}{\begin{multicols}{#1}}
    $endif$
    \tableofcontents
    $if(article)$$else$
    \ifthenelse{\equal{#1}{1}}{}{\end{multicols}}
    \begin{pppmulticol}
    $endif$
  }
  \newcommand\ppplistof[2][1]{
    $if(article)$$else$
    \end{pppmulticol}
    \ifthenelse{\equal{#1}{1}}{}{\begin{multicols}{#1}}
    $endif$
